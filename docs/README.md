...
| Authentication, authorization, secrets, SSRF, redaction, and publisher admission controls | [Security Baseline](SECURITY_BASELINE.md), [ADR-010](adr/0010-local-publisher-rate-limiting.md), [ADR-011](adr/0011-durable-project-daily-publish-quota.md) |
