...
The next task is the first bounded business migration: create and test only the `owner_accounts` physical table and its database invariants. Do not add JPA mappings, repositories, authentication behavior, or another business table in that slice.
